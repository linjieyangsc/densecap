GPU_ID=2
NET_FINAL=output/faster_rcnn_end2end/vg_train/faster_rcnn_cap_two_stage5_512_iter_200000.caffemodel
...
time ./lib/tools/test_net_cap_two_stage.py --gpu ${GPU_ID} \
  ...
  --def_recurrent models/${PT_DIR}/test_cap_pred5_512.prototxt \
