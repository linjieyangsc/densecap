GPU_ID=0
NET_FINAL=output/faster_rcnn_end2end/vg_1.0_train/faster_rcnn_cap_two_lstm_context_ef_sum_finetune_iter_200000.caffemodel
...
time ./lib/tools/test_net_cap_two_stage.py --gpu ${GPU_ID} \
  ...
  --def_recurrent models/${PT_DIR}/test_cap_pred_two_lstm_context_ef_sum.prototxt \
