...
def main():
  ...
  DATASET_CACHE_DIR = './cache/%s/%s' % (DATASET_SUBDIR, MODEL_FILENAME)
  VOCAB_FILE = './models/lstm/h5_data_distill2/buffer_100/vocabulary'
  DEVICE_ID = -1
  ...
  captioner = Captioner(MODEL_FILE, IMAGE_NET_FILE, WORD_EMBEDDING_FILE, LSTM_NET_FILE, VOCAB_FILE,
                        device_id=DEVICE_ID)
  beam_size = 3
