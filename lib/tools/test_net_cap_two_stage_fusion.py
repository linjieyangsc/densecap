...
import _init_paths
from fast_rcnn.test_cap_two_stage_fusion import test_net
...
def parse_args():
    ...
    parser.add_argument('--net', dest='caffemodel',
                        help='model to test',
                        default=None, type=str)
    parser.add_argument('--def_fusion', dest='fusion_prototxt',
                        help='prototxt file defining the network (for feature fusion)',
                        default= None, type=str)
...
if __name__ == '__main__':
    ...
    fusion_net = caffe.Net(args.fusion_prototxt, args.caffemodel, caffe.TEST)
    ...
    test_net(feature_net, fusion_net, embed_net, recurrent_net, imdb, \
