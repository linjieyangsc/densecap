...
import _init_paths
from fast_rcnn.test_cap_cross import test_net
...
def parse_args():
    ...
    parser.add_argument('--def_embed', dest='embed_prototxt',
                        ...
                        default=None, type=str)
    parser.add_argument('--def_offset', dest='offset_prototxt',
                        help='prototxt file defining the network (for feature offset)',
                        default=None, type=str)
...
if __name__ == '__main__':
    ...
    offset_net = caffe.Net(args.offset_prototxt, args.caffemodel, caffe.TEST)
    ...
    test_net(feature_net, embed_net, recurrent_net, offset_net, imdb, max_per_image=args.max_per_image, vis=args.vis)
